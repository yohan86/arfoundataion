...
const ServiceBox=({bgcolor}:ServiceProps)=> {
  return (
    

        <div className="servicebox flex w-full h-[378px] overflow-hidden md:h-[458px] md:w-1/2 lg:w-1/3">
            <div className={`box-intro relative w-full h-[178px] md:h-[264px]  mt-[200px] px-5 py-5 bg-[${bgcolor}] text-white link-color-pink`}>
